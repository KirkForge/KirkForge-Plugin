...
const cRules: LintRule[] = [
  { id: "no-gets", category: "safety", severity: "critical", pattern: /\bgets\s*\(/g, message: "gets() has no bounds checking and can overflow any buffer — use fgets(buf, sizeof(buf), stdin) with an explicit size limit" },
  ...
  { id: "no-goto", category: "style", severity: "med", pattern: /\bgoto\s+\w+/g, message: "goto makes control flow hard to follow — use if/else, loops, or extract a function; break/continue cover most cases" },
