...
import { mkdtempSync, readFileSync, existsSync, rmSync, mkdirSync, symlinkSync, writeFileSync } from "node:fs";
...
describe("StateReducer", () => {
  it("reduces signals to packet", async () => {
    ...
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s1", taskId: "t1", value: { status: "fail", errors: 2, warnings: 1, filesScanned: 5, durationMs: 100, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s1", taskId: "t1", value: { status: "pass", errors: 0, durationMs: 50, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.changes", schemaVersion: "v3", sequence: 3, streamId: "s1", taskId: "t1", value: { filesChanged: 3, paths: ["a.ts", "b.ts"], insertions: 10, deletions: 2, durationMs: 30 }, timestamp: "now" });
  ...
  it("returns pass when clean", async () => {
    const bus = new EventBus();
    const reducer = new StateReducer(bus);
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s2", taskId: "t2", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 3, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s2", taskId: "t2", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.security", schemaVersion: "v3", sequence: 3, streamId: "s2", taskId: "t2", value: { status: "pass", findings: 0, critical: 0, high: 0, filesScanned: 3, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.graph", schemaVersion: "v3", sequence: 4, streamId: "s2", taskId: "t2", value: { status: "pass", edgeCount: 0, newEdges: 0, brokenEdges: 0, cycles: 0, durationMs: 10 }, timestamp: "now" });
  ...
  it("fails closed when verifier signals are missing", async () => {
    const bus = new EventBus();
    const reducer = new StateReducer(bus);
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s3", taskId: "t3", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
  ...
  it("fails closed on explicit verifier error", async () => {
    const bus = new EventBus();
    const reducer = new StateReducer(bus);
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s4", taskId: "t4", value: { status: "error", error: "eslint config exploded", errors: 1, warnings: 0, filesScanned: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s4", taskId: "t4", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.security", schemaVersion: "v3", sequence: 3, streamId: "s4", taskId: "t4", value: { status: "pass", findings: 0, critical: 0, high: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.graph", schemaVersion: "v3", sequence: 4, streamId: "s4", taskId: "t4", value: { status: "pass", edgeCount: 0, newEdges: 0, brokenEdges: 0, cycles: 0, durationMs: 10 }, timestamp: "now" });
  ...
  it("fails closed when artifact.blocked signal exists", async () => {
    const bus = new EventBus();
    const reducer = new StateReducer(bus);
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s5", taskId: "t5", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s5", taskId: "t5", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.security", schemaVersion: "v3", sequence: 3, streamId: "s5", taskId: "t5", value: { status: "pass", findings: 0, critical: 0, high: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.graph", schemaVersion: "v3", sequence: 4, streamId: "s5", taskId: "t5", value: { status: "pass", edgeCount: 0, newEdges: 0, brokenEdges: 0, cycles: 0, durationMs: 10 }, timestamp: "now" });
    await bus.emit({ kind: "artifact.blocked", schemaVersion: "v3", sequence: 5, streamId: "s5", taskId: "t5", value: { blockedPaths: [{ path: "output.ts", reason: "python task cannot emit output.ts" }] }, timestamp: "now" });
    ...
    expect(packet.artifactEnforcement?.blockedPaths[0]?.reason).toBe("python task cannot emit output.ts");
  });
  ...
  it("fails when required verifier is missing (with policy)", async () => {
    ...
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s7", taskId: "t7", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
  ...
  it("fails when required verifier is skipped (with policy)", async () => {
    ...
    const reducer = new StateReducer(bus);
    const policy: VerifierPolicy = { required: ["lint", "types"], advisory: ["graph"] };
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s8", taskId: "t8", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s8", taskId: "t8", value: { status: "skipped", errors: 0, durationMs: 0, details: [] }, timestamp: "now" });
  ...
  it("advisory skipped graph does not fail by itself when required verifiers pass", async () => {
    ...
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s9", taskId: "t9", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s9", taskId: "t9", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.security", schemaVersion: "v3", sequence: 3, streamId: "s9", taskId: "t9", value: { status: "pass", findings: 0, critical: 0, high: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.graph", schemaVersion: "v3", sequence: 4, streamId: "s9", taskId: "t9", value: { status: "skipped", edgeCount: 0, newEdges: 0, brokenEdges: 0, cycles: 0, durationMs: 0 }, timestamp: "now" });
  ...
  it("no policy preserves old fail-closed behavior (missing verifiers cause error status)", async () => {
    const bus = new EventBus();
    const reducer = new StateReducer(bus);
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s10", taskId: "t10", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
  ...
  it("missing advisory slots do not force fail when policy is provided", async () => {
    ...
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s11", taskId: "t11", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s11", taskId: "t11", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
  ...
  it("advisory verifier with critical findings still fails even when advisory", async () => {
    ...
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s12", taskId: "t12", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s12", taskId: "t12", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.security", schemaVersion: "v3", sequence: 3, streamId: "s12", taskId: "t12", value: { status: "fail", findings: 3, critical: 1, high: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
  ...
  it("no policy with only passing lint/types still fails (fail-closed)", async () => {
    const bus = new EventBus();
    const reducer = new StateReducer(bus);
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s13", taskId: "t13", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s13", taskId: "t13", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
  ...
  it("no policy with graph brokenEdges still fails (backward compatible)", async () => {
    const bus = new EventBus();
    const reducer = new StateReducer(bus);
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s14", taskId: "t14", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s14", taskId: "t14", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.security", schemaVersion: "v3", sequence: 3, streamId: "s14", taskId: "t14", value: { status: "pass", findings: 0, critical: 0, high: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.graph", schemaVersion: "v3", sequence: 4, streamId: "s14", taskId: "t14", value: { status: "fail", edgeCount: 5, newEdges: 0, brokenEdges: 2, cycles: 0, durationMs: 10 }, timestamp: "now" });
  ...
  it("graph advisory with brokenEdges produces warn, not fail", async () => {
    ...
    const reducer = new StateReducer(bus);
    const policy: VerifierPolicy = { required: ["lint", "types", "security"], advisory: ["graph"] };
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s15", taskId: "t15", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s15", taskId: "t15", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.security", schemaVersion: "v3", sequence: 3, streamId: "s15", taskId: "t15", value: { status: "pass", findings: 0, critical: 0, high: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.graph", schemaVersion: "v3", sequence: 4, streamId: "s15", taskId: "t15", value: { status: "fail", edgeCount: 5, newEdges: 0, brokenEdges: 3, cycles: 0, durationMs: 10 }, timestamp: "now" });
  ...
  it("graph required with brokenEdges fails", async () => {
    const bus = new EventBus();
    const reducer = new StateReducer(bus);
    const policy: VerifierPolicy = { required: ["lint", "types", "security", "graph"], advisory: [] };
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s16", taskId: "t16", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s16", taskId: "t16", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.security", schemaVersion: "v3", sequence: 3, streamId: "s16", taskId: "t16", value: { status: "pass", findings: 0, critical: 0, high: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.graph", schemaVersion: "v3", sequence: 4, streamId: "s16", taskId: "t16", value: { status: "fail", edgeCount: 5, newEdges: 0, brokenEdges: 2, cycles: 0, durationMs: 10 }, timestamp: "now" });
  ...
  it("graph absent from policy with brokenEdges does not affect overall", async () => {
    ...
    await bus.emit({ kind: "verify.lint", schemaVersion: "v3", sequence: 1, streamId: "s17", taskId: "t17", value: { status: "pass", errors: 0, warnings: 0, filesScanned: 1, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "verify.types", schemaVersion: "v3", sequence: 2, streamId: "s17", taskId: "t17", value: { status: "pass", errors: 0, durationMs: 10, details: [] }, timestamp: "now" });
    await bus.emit({ kind: "state.graph", schemaVersion: "v3", sequence: 3, streamId: "s17", taskId: "t17", value: { status: "fail", edgeCount: 5, newEdges: 0, brokenEdges: 4, cycles: 0, durationMs: 10 }, timestamp: "now" });
  ...
  it("task profile has verifierPolicy for each language", () => {
    const languages = ["typescript", "javascript", "python", "shell", "cpp", "c", "rust", "go", "sql", "text"] as const;
...
describe("classifyTask", () => {
  ...
  it("artifact overrides schema-contract for code-gen with mixed keywords", () => {
    expect(classifyTask({ description: "write a TypeScript server with validation" }).mode).toBe("artifact");
  });
...
describe("task profile routing", () => {
  it("detects Python and shell tasks before prompting", () => {
    expect(detectTaskProfile("fix broken-python pandas csv-to-parquet script").language).toBe("python");
  ...
  it("persists unlabelled code blocks with the detected default extension", async () => {
    ...
    try {
      const result = await executeHardPrompt(agent as any, { description: "fix broken-python" }, "task-1", cwd, detectTaskProfile("fix broken-python"));
  ...
  it("strips outer markdown fences from artifact file contents", async () => {
    ...
    const agent = {
      execute: async () => ({
        ...
        value: {
          agentId: "agent-test",
          content: JSON.stringify({ type: "file_write", path: "solution.py", sha256: sha256Of("print('ok')\n"), content_b64: Buffer.from("print('ok')\n", "utf-8").toString("base64") }),
          promptTokens: 1,
          completionTokens: 1,
          totalTokens: 2,
          model: "stub",
    ...
    try {
      const result = await executeArtifact(agent as any, { description: "write solution.py" }, "task-artifact", cwd, detectTaskProfile("broken-python"));
      expect(result.ok).toBe(true);
...
describe("hard-prompt artifact enforcement", () => {
  ...
  it("allows valid Python file in hard-prompt mode", async () => {
    ...
    try {
      ...
      const result = await executeHardPrompt({ execute: async () => ({ ok: true, value: { agentId: "a", content, promptTokens: 1, completionTokens: 1, totalTokens: 2, model: "stub", format: "hard-prompt" } }) } as any, { description: "fix broken-python" }, "hp-valid", cwd, pythonProfile);
      expect(result.ok).toBe(true);
      if (result.ok) {
  ...
  it("writes to profile default file regardless of code block language annotation", async () => {
    ...
    try {
      ...
      const result = await executeHardPrompt({ execute: async () => ({ ok: true, value: { agentId: "a", content, promptTokens: 1, completionTokens: 1, totalTokens: 2, model: "stub", format: "hard-prompt" } }) } as any, { description: "write a python script" }, "hp-wrongext", cwd, pythonProfile);
      expect(result.ok).toBe(true);
      if (result.ok) {
        const fileSignal = result.value.signals.find(s => s.kind === "files.written");
        expect(fileSignal).toBeDefined();
  ...
  it("blocks path traversal in hard-prompt mode", async () => {
    ...
    try {
      const content = "```python\nimport os\n```";
      const result = await executeHardPrompt({ execute: async () => ({ ok: true, value: { agentId: "a", content, promptTokens: 1, completionTokens: 1, totalTokens: 2, model: "stub", format: "hard-prompt" } }) } as any, { description: "write a python script" }, "hp-traversal", cwd, pythonProfile);
      expect(result.ok).toBe(true);
      if (result.ok) {
  ...
  it("hard-prompt always uses profile default file as output path", async () => {
    ...
    try {
      const content = "```typescript\n// Fix for output.ts\nconsole.log('hi')\n```";
      const result = await executeHardPrompt({ execute: async () => ({ ok: true, value: { agentId: "a", content, promptTokens: 1, completionTokens: 1, totalTokens: 2, model: "stub", format: "hard-prompt" } }) } as any, { description: "write python script" }, "hp-signal", cwd, pythonProfile);
      expect(result.ok).toBe(true);
      if (result.ok) {
        const fileSignal = result.value.signals.find(s => s.kind === "files.written");
        expect(fileSignal).toBeDefined();
...
describe("decideCorrection", () => {
  const okPacket = {
    ...
    verification: { lint: { errors: 0, warnings: 0 }, types: { errors: 0 }, security: { findings: 0, critical: 0, high: 0 }, overall: "pass" as const },
    contributingSignals: [],
  };
  it("accepts clean", () => expect(decideCorrection(okPacket, 0, 3, 100, 100, 0).action).toBe("accept"));
  it("escalates critical security (no policy, backward compat)", () => expect(decideCorrection({ ...okPacket, verification: { ...okPacket.verification, security: { findings: 1, critical: 1, high: 0 } } }, 0, 3, 100, 100, 0).action).toBe("escalate"));
  it("escalates critical security (security required)", () => {
    const packet = { ...okPacket, verification: { ...okPacket.verification, security: { findings: 1, critical: 1, high: 0 } }, verifierPolicy: { required: ["lint", "types", "security"], advisory: [] as string[], missingRequired: [] as string[], skippedRequired: [] as string[] } };
  ...
  it("corrects critical security instead of escalating (security advisory)", () => {
    const packet = {
      ...okPacket,
      verification: { ...okPacket.verification, security: { findings: 2, critical: 1, high: 0 }, overall: "fail" as const },
      verifierPolicy: { required: ["lint", "types"], advisory: ["security"], missingRequired: [] as string[], skippedRequired: [] as string[] },
    };
  ...
  it("corrects critical security instead of escalating (security absent from policy)", () => {
    const packet = {
      ...okPacket,
      verification: { ...okPacket.verification, security: { findings: 2, critical: 1, high: 0 }, overall: "fail" as const },
      verifierPolicy: { required: ["lint", "types"], advisory: ["graph"], missingRequired: [] as string[], skippedRequired: [] as string[] },
    };
    const d = decideCorrection(packet, 0, 3, 100, 100, 0);
    expect(d.action).toBe("correct");
    expect(d.correctionPrompt).toBeTruthy();
  });
  it("escalates broken edges (no policy)", () => expect(decideCorrection({ ...okPacket, graph: { ...okPacket.graph, brokenEdges: 1 } }, 0, 3, 100, 100, 0).action).toBe("escalate"));
  it("escalates broken edges (graph required)", () => {
    const packet = { ...okPacket, graph: { ...okPacket.graph, brokenEdges: 2 }, verifierPolicy: { required: ["lint", "types", "security", "graph"], advisory: [] as string[], missingRequired: [] as string[], skippedRequired: [] as string[] } };
    expect(decideCorrection(packet, 0, 3, 100, 100, 0).action).toBe("escalate");
  });
  it("corrects broken edges (graph advisory) instead of escalating", () => {
    const packet = {
      ...
      verifierPolicy: { required: ["lint", "types", "security"], advisory: ["graph"], missingRequired: [] as string[], skippedRequired: [] as string[] },
    };
    const d = decideCorrection(packet, 0, 3, 100, 100, 0);
    expect(d.action).toBe("correct");
    expect(d.correctionPrompt).toBeTruthy();
  ...
  it("does not escalate broken edges when graph absent from policy", () => {
    const packet = {
      ...
      verification: { ...okPacket.verification, overall: "warn" as const },
      verifierPolicy: { required: ["lint", "types"], advisory: [] as string[], missingRequired: [] as string[], skippedRequired: [] as string[] },
    };
    const d = decideCorrection(packet, 0, 3, 100, 100, 0);
    expect(d.action).toBe("correct");
  });
  it("corrects lint errors", () => {
    const d = decideCorrection({ ...okPacket, verification: { ...okPacket.verification, lint: { errors: 2, warnings: 0 }, overall: "fail" as const } }, 0, 3, 100, 100, 0);
    expect(d.action).toBe("correct");
    expect(d.correctionPrompt).toBeTruthy();
  });
  it("escalates max corrections", () => expect(decideCorrection({ ...okPacket, verification: { ...okPacket.verification, lint: { errors: 1, warnings: 0 }, overall: "fail" as const } }, 3, 3, 100, 100, 0).action).toBe("escalate"));

  it("taskPass=true accepts even with other conditions", () => {
    expect(decideCorrection(okPacket, 0, 3, 100, 100, 0, undefined, undefined, true).action).toBe("accept");
  });
  ...
  it("taskPass=undefined falls through to verifier logic (no validator)", () => {
    expect(decideCorrection(okPacket, 0, 3, 100, 100, 0, undefined, undefined, undefined).action).toBe("accept");
  });
});
...
describe("artifact path and extension enforcement", () => {
  ...
  it("blocks long unknown extension that bypasses allowed list", () => {
    ...
    try {
      const { artifacts } = parseArtifacts("### FILE: payload.notallowedbutlong\nprint('nope')\n### END");
      const results = writeArtifacts(artifacts, cwd, pythonProfile);
      expect(results).toHaveLength(1);
      expect(results[0].ok).toBe(false);
...
describe("correction loop memory metadata", () => {
  it("stores actual model name instead of 'session'", { timeout: 30000 }, async () => {
    ...
    const modelConfig = { providers: { "test-provider": { provider: "ollama" as const, baseUrl: "http://localhost", defaultModel: "test-model-xyz" } }, defaultProvider: "test-provider" };
    ...
    orchestrator.stubDelegate(async (task: TaskInput) => {
      ...
      return ok({
        ...
        emission: { agentId: "a1", content: "```python\nprint('hi')\n```", promptTokens: 10, completionTokens: 20, totalTokens: 30, model: "test-model-xyz", format: "artifact" as const },
        signals: [{ id: "s1", taskId: task.taskId ?? "test", domain: "files", kind: "files.written", source: "agent", ts: new Date().toISOString(), value: { files: ["solution.py"] } }],
        packet,
      });
    });
  ...
  it("stores nonzero durationMs", async () => {
    const adapter = new InMemoryAdapter();
    const store = new MemoryStore(adapter);
    const modelConfig = { providers: { "test-provider": { provider: "ollama" as const, baseUrl: "http://localhost", defaultModel: "test-model" } }, defaultProvider: "test-provider" };
    const orchestrator = new TestableOrchestrator({ modelConfig, memoryStore: store });
    ...
    orchestrator.stubDelegate(async (task: TaskInput) => {
      ...
      return ok({
        ...
        emission: { agentId: "a1", content: "```python\nprint('ok')\n```", promptTokens: 10, completionTokens: 20, totalTokens: 30, model: "test-model", format: "hard-prompt" as const },
        signals: [{ id: "s1", taskId: task.taskId ?? "test", domain: "files", kind: "files.written", source: "agent", ts: new Date().toISOString(), value: { files: ["solution.py"] } }],
        packet,
      });
    });
  ...
  it("stores actual mode from emission format, not guessed from verifierOverall", async () => {
    ...
    orchestrator.stubDelegate(async (task: TaskInput) => {
      ...
      return ok({
        decision: { mode: "artifact" },
        emission: { agentId: "a1", content: "### FILE: solution.py\nprint('ok')\n### END", promptTokens: 10, completionTokens: 20, totalTokens: 30, model: "test-model", format: "artifact" as const },
        signals: [{ id: "s1", taskId: task.taskId ?? "test", domain: "files", kind: "files.written", source: "agent", ts: new Date().toISOString(), value: { files: ["solution.py"] } }],
        packet,
      });
    });
  ...
  it("taskPass=false with verifier pass records unknown", async () => {
    ...
    orchestrator.stubDelegate(async (task: TaskInput) => {
      ...
      return ok({
        decision: { mode: "hard-prompt" },
        emission: { agentId: "a1", content: "```python\nprint('fixed')\n```", promptTokens: 5, completionTokens: 10, totalTokens: 15, model: "test-model", format: "hard-prompt" as const },
        signals: [],
        packet,
      });
    });
...
describe("validator integration: real shell commands", () => {
  ...
  beforeAll(() => { process.env.ALLOW_UNSAFE_VALIDATOR_SHELL = "1"; });
  afterAll(() => { if (prevAllowUnsafe === undefined) delete process.env.ALLOW_UNSAFE_VALIDATOR_SHELL; else process.env.ALLOW_UNSAFE_VALIDATOR_SHELL = prevAllowUnsafe; });
  const modelConfig = { providers: { "test-provider": { provider: "ollama" as const, baseUrl: "http://localhost", defaultModel: "test-model" } }, defaultProvider: "test-provider" };
  ...
  it("validator exit 0 -> finalVerdict pass, sourceOfTruth task-validator, taskPass true", async () => {
    ...
    orchestrator.stubDelegate(async () => {
      ...
      return ok({
        decision: { mode: "hard-prompt" },
        emission: { agentId: "a1", content: "```python\nprint('ok')\n```", promptTokens: 10, completionTokens: 20, totalTokens: 30, model: "test-model", format: "hard-prompt" as const },
        signals: [{ id: "s1", taskId: "v-pass", domain: "files", kind: "files.written", source: "agent", ts: new Date().toISOString(), value: { files: ["solution.py"] } }],
        packet,
      });
    });
  ...
  it("validator exit 1 -> finalVerdict fail, taskPass false, no accept", async () => {
    ...
    orchestrator.stubDelegate(async () => {
      ...
      return ok({
        decision: { mode: "hard-prompt" },
        emission: { agentId: "a1", content: "```python\nprint('ok')\n```", promptTokens: 10, completionTokens: 20, totalTokens: 30, model: "test-model", format: "hard-prompt" as const },
        signals: [{ id: "s1", taskId: "v-fail", domain: "files", kind: "files.written", source: "agent", ts: new Date().toISOString(), value: { files: ["solution.py"] } }],
        packet,
      });
    });
  ...
  it("validator timeout -> finalVerdict unknown, taskPass null", async () => {
    ...
    orchestrator.stubDelegate(async () => {
      ...
      return ok({
        decision: { mode: "hard-prompt" },
        emission: { agentId: "a1", content: "```python\nprint('ok')\n```", promptTokens: 10, completionTokens: 20, totalTokens: 30, model: "test-model", format: "hard-prompt" as const },
        signals: [{ id: "s1", taskId: "v-timeout", domain: "files", kind: "files.written", source: "agent", ts: new Date().toISOString(), value: { files: ["solution.py"] } }],
        packet,
      });
    });
  ...
  it("validator pass with verifier fail still uses task-validator as sourceOfTruth", async () => {
    ...
    orchestrator.stubDelegate(async () => {
      ...
      const packet = {
        ...
        turn: 0,
        ts: new Date().toISOString(),
        verification: { lint: { errors: 1, warnings: 0 }, types: { errors: 1 }, security: { findings: 0, critical: 0, high: 0 }, overall: "fail" as const },
        changes: { filesChanged: 1, paths: ["solution.py"], insertions: 5, deletions: 0 },
        graph: { edgeCount: 0, newEdges: 0, brokenEdges: 0, cycles: 0 },
        contributingSignals: [],
      };
      return ok({
        decision: { mode: "hard-prompt" },
        emission: { agentId: "a1", content: "```python\nprint('ok')\n```", promptTokens: 10, completionTokens: 20, totalTokens: 30, model: "test-model", format: "hard-prompt" as const },
        signals: [{ id: "s1", taskId: "v-src", domain: "files", kind: "files.written", source: "agent", ts: new Date().toISOString(), value: { files: ["solution.py"] } }],
        packet,
      });
    });
  ...
  it("validator result is JSON-serializable (CLI compatibility)", async () => {
    ...
    orchestrator.stubDelegate(async () => {
      ...
      return ok({
        decision: { mode: "hard-prompt" },
        emission: { agentId: "a1", content: "```python\nprint('ok')\n```", promptTokens: 10, completionTokens: 20, totalTokens: 30, model: "test-model", format: "hard-prompt" as const },
        signals: [{ id: "s1", taskId: "v-json", domain: "files", kind: "files.written", source: "agent", ts: new Date().toISOString(), value: { files: ["solution.py"] } }],
        packet,
      });
    });
    ...
    const result = await orchestrator.runCorrectionLoop(
      ...
      { maxCorrections: 0, validator: { shellCommand: "echo 'all tests passed'", timeoutMs: 5000 } },
    );
