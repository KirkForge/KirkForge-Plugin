...
export function setModelResponseAttributes(
  ...
  if (attrs.promptTokens != null) span.setAttribute("gen_ai.usage.input_tokens", attrs.promptTokens);
  if (attrs.completionTokens != null) span.setAttribute("gen_ai.usage.output_tokens", attrs.completionTokens);
  if (attrs.totalTokens != null) span.setAttribute("gen_ai.usage.total_tokens", attrs.totalTokens);
  if (attrs.reasoningTokens != null) span.setAttribute("gen_ai.usage.reasoning_tokens", attrs.reasoningTokens);
