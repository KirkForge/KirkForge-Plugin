...
This document is a starting point for enterprise/security review. It explains what data 55NDeep *can* store, why it exists, and how to minimize/retain/delete it.
